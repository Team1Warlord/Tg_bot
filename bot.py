...
def replying(message):
    if message.text == "/help":
        ...
        bot.send_message(message.from_user.id, "Введите дату пройденного урока")
...
def give_translate(message):
    ...
    if compr == []:
        bot.send_message(message.from_user.id, "Такого слова в словаре нема, занесите его в словарь")
    else:
